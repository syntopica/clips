  ...
  it('refuses a change that drops a superseded belief', async () => {
    ...
    expect(await validateWorktree(BRAIN, root)).toEqual({
      ...
      failure: {
        ...
        reason:
          'projects/pyfirma.md: ## Contested lost 1 entry(ies), starting "2026-08-01: the page held A; it now holds B, because the rep"; a superseded belief is kept, never overwritten',
      },
    })
  })
